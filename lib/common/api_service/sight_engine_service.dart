...
class SightEngineService {
  ...
  Future<void> checkImageInSightEngine({XFile? xFile, required Function() completion}) async {
  ...
  Future<void> checkVideoInSightEngine({XFile? xFile, required Function() completion}) async {
    if (SessionManager.shared.getSettings()?.isSightEngineEnabled == 0) {
      completion();
      return;
    }
