          ...
          children: [
            SpeedDialChild(
                labelWidget: Container(
                    ...
                    decoration: const ShapeDecoration(color: cWhite, shape: SmoothRectangleBorder(borderRadius: SmoothBorderRadius.all(SmoothRadius(cornerSmoothing: cornerSmoothing, cornerRadius: 8)))),
                    child: Text(
                      LKeys.createStory.tr,
                      style: MyTextStyle.gilroyMedium(),
                    )),
                onTap: () {
                  Get.bottomSheet(CreateStoryScreen(user: SessionManager.shared.getUser() ?? User()), isScrollControlled: true, ignoreSafeArea: false).then((value) {
            ...
            SpeedDialChild(
                onTap: () {
                  Navigate.to(AddPostScreen())?.then((value) {
                    InterstitialManager.shared.showAd();
                    if (value is Feed) {
                      if (onPostBack != null) {
                        onPostBack!(value);
