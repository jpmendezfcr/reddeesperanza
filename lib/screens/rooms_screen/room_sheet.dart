                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          ClipOval(
                            child: MyCachedImage(imageUrl: room.photo, width: 60, height: 60),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  room.title ?? '',
                                  style: MyTextStyle.gilroyBold(size: 19, color: cWhite),
                                  maxLines: 1,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      LKeys.members.tr,
                                      style: MyTextStyle.gilroyLight(size: 16, color: cPrimary),
                                    ),
                                  ],
                                ),
                              ],
                      ...
                      Text(
                        room.desc ?? '',
                        style: MyTextStyle.outfitLight(color: cLightIcon),
                      ),
                                      ...
                                      ? Column(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: MyTextStyle.gilroyBold(size: 20, color: cLightIcon),
                                            ),
                                            const SizedBox(height: 10),
                                            Text(
                                              LKeys.requestToJoinDesc.tr,
                                              style: MyTextStyle.gilroyLight(color: cLightIcon, size: 16),
                                            ),
                                            const SizedBox(height: 20),
                                          ],
                                        )
                      ...
                      isFromInfo
                          ? Container()
                          : CommonSheetButton(
                              color: controller.room.getUserAccessType() == GroupUserAccessType.requested ? cLightText.withValues(alpha: 0.7) : cWhite,
                              title: room.getUserAccessType() == GroupUserAccessType.invited
                                  ? LKeys.acceptInvitation
                                  : room.isJoinRequestEnable == 1
                                      ? controller.room.getUserAccessType() == GroupUserAccessType.requested
                                          ? LKeys.requested
                                          : LKeys.requestToJoin
                                      : LKeys.joinThisRoom,
      ...
      child: Column(
        ...
        children: [
            ...
            child: Stack(
              children: List.generate(room.roomUsers?.length ?? 0, (index) {
                return Positioned(
                  left: index * 40,
                  child: Container(
                    decoration: BoxDecoration(border: Border.all(color: cWhite.withValues(alpha: 0.8), width: 2), shape: BoxShape.circle),
          ...
          GestureDetector(
            onTap: () {
              Get.back();
              Navigate.to(ProfileScreen(userId: room.admin?.id ?? 0));
            },
            child: Row(
              children: [
                Text(
