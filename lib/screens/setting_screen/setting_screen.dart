                ...
                child: SafeArea(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      (SessionManager.shared.getUser()?.isVerified != 2 && SessionManager.shared.getUser()?.isVerified != 3)
                          ? SettingButton(
...
class SettingButtonWithSwitch extends StatelessWidget {
  ...
  const SettingButtonWithSwitch({Key? key, required this.title, required this.desc, required this.isOn, required this.onChange}) : super(key: key);
