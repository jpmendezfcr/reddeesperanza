...
class JoinRequestsScreen extends StatelessWidget {
  ...
  const JoinRequestsScreen({Key? key, required this.controller}) : super(key: key);
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return RoomMemberCard(
                                ...
                                onRequestAccept: () {
                                  controller.acceptRequest(controller.joinRequests[index]);
                                },
                                onRequestReject: () {
                                  controller.rejectRequest(controller.joinRequests[index]);
                                },
                              );
                            },
                          ));
