...
class ReportSheet extends StatelessWidget {
  ...
  const ReportSheet({Key? key, this.user, this.room, this.post}) : super(key: key);
          ...
          child: Wrap(
            children: [
              Column(
                ...
                children: [
                  Row(
                    children: [sheetHeading().toTextTR(MyTextStyle.gilroyLight(color: cPrimary)), const Spacer(), const XMarkButton()],
                  ),
                  ...
                  dropDown(controller),
                  const SizedBox(height: 20),
                  LKeys.tellUsMore.toTextTR(MyTextStyle.gilroyLight(color: cWhite)),
    ...
    return GetBuilder<ReportController>(
        ...
        builder: (context) {
          return Container(
            ...
            child: DropdownButton<ReportReasons>(
              ...
              items: controller.reasons.map<DropdownMenuItem<ReportReasons>>((ReportReasons value) {
                return DropdownMenuItem<ReportReasons>(
                  value: value,
