  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: DetectableText(
        ...
        lessStyle: MyTextStyle.gilroyMedium(color: cHashtagColor),
        moreStyle: MyTextStyle.gilroyMedium(color: cHashtagColor),
        trimCollapsedText: LKeys.showMore.tr,
        trimExpandedText: '  ${LKeys.showLess.tr}',
        text: controller.post.desc ?? '',
        basicStyle: MyTextStyle.outfitLight(size: 16, color: isForVideo ? cLightIcon : cMainText),
        detectedStyle: MyTextStyle.outfitLight(size: 16, color: cHashtagColor),
      ),
    );
  }
}
        ...
        children: [
          ...
          Obx(
            () => LikeButton(
              ...
              likeCount: this.controller.post.likesCount,
              size: 21,
