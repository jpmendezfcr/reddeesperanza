...
class RoomInvitationCard extends StatelessWidget {
  ...
  const RoomInvitationCard({Key? key, required this.invitation, required this.onAccept, required this.onReject}) : super(key: key);
                  ...
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          decoration: ShapeDecoration(shape: const SmoothRectangleBorder(borderRadius: SmoothBorderRadius.all(SmoothRadius(cornerRadius: 8, cornerSmoothing: cornerSmoothing))), color: cLightBg),
