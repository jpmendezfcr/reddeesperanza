...
class AudioSpaceCard extends StatelessWidget {
  ...
  void _onTapHandler(BuildContext context) {
    ...
    if (listenersLimit == 0 || audioSpace.requestsAndListener.length < listenersLimit) {
      var user = audioSpace.users?.firstWhereOrNull((u) => u.id == SessionManager.shared.getUserID());
