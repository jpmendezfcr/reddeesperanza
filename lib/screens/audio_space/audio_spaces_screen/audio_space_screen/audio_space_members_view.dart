    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ClipRRect(
              borderRadius: SmoothBorderRadius(cornerRadius: 20, cornerSmoothing: cornerSmoothing),
            ...
            if (!isAdmin && controller.showOptionsShow) Expanded(child: options())
          ],
        ),
      ),
    );
                ...
                child: SafeArea(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(children: [
                        ClipRRect(
                          borderRadius: SmoothBorderRadius(cornerRadius: 15, cornerSmoothing: cornerSmoothing),
                          child: MyCachedProfileImage(
                            imageUrl: user.image,
                            height: 60,
                            width: 60,
